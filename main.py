...
st.markdown("<h4 style='text-align: center; color: gray;'>Desarrollado por Rodrigo Montes de Oca Guarneros bajo la supervisión del Dr. Eddy Sánchez de la Cruz.</h4>")
